...
(function ($) {
    ...
    $.fn.extend({
         ...
         * 删除元素
         */
        delete: function (index, url,text='确定要删除吗？') {
        ...
        selectImages: function (option) {
            ...
            $this.fileLibrary({
                ...
                , done: function (data, $touch) {
                    ...
                    // 新增图片列表
                    var $html = $(template('tpl-file-item', {list: list, name: options.name,image_alt:options.image_alt,image_name:options.image_name}))
