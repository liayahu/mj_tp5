...
--
-- Host: 127.0.0.1
-- Generation Time: 2023-05-15 16:00:45
-- 服务器版本： 5.5.53
-- PHP Version: 7.0.12
...
--
-- 表的结构 `hishop_admin_user`
--

CREATE TABLE IF NOT EXISTS `hishop_admin_user` (
...
--
-- 转存表中的数据 `hishop_admin_user`
--

INSERT INTO `hishop_admin_user` (`admin_user_id`, `user_name`, `password`, `create_time`, `update_time`) VALUES
(10001, 'admin', '2150fc4fd844434de6ecf45439b5b556', 1529926348, 1684162959);
...
CREATE TABLE IF NOT EXISTS `hishop_article` (
  `article_id` int(11) unsigned NOT NULL COMMENT '文章id',
  `article_name` varchar(255) NOT NULL DEFAULT '' COMMENT '文章名称',
  `search_name` varchar(255) NOT NULL DEFAULT '' COMMENT '索引标题',
  `keywords` varchar(200) NOT NULL DEFAULT '' COMMENT '关键词',
  `description` varchar(255) NOT NULL DEFAULT '' COMMENT '文章描述',
  `art_category_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '文章分类id',
  `content` longtext NOT NULL COMMENT '文章详情',
  `sales_initial` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '初始阅读',
  `sales_actual` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '实际阅读',
  `article_sort` int(11) unsigned NOT NULL DEFAULT '100' COMMENT '文章排序(数字越小越靠前)',
  `article_status` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '文章状态(10上架 20下架)',
  `is_delete` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `is_home` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '10不展示首页，20展示首页',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `hishop_article`
--

INSERT INTO `hishop_article` (`article_id`, `article_name`, `search_name`, `keywords`, `description`, `art_category_id`, `content`, `sales_initial`, `sales_actual`, `article_sort`, `article_status`, `is_delete`, `is_home`, `create_time`, `update_time`) VALUES
(3, 'How to choose high quality manufacturers when purchasing magnets', 'How-to-choose-high-quality-manufacturers-when-purchasing-magnets', 'How to choose high quality manufacturers when purchasing magnets', 'How to choose high quality manufacturers when purchasing magnets', 10003, '&lt;p&gt;&lt;span&gt;Nowadays, as a common magnetic component in industrial production, the strong temperature resistant magnet is widely used in many enterprises, toy factories, electronic factories and so on. Only because of the different production styles and specifications, the quantity needed is more or less. So in the face of a variety of brands, how should we choose?&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;First of all, when we select a strong magnet manufacturer, we must first make a general understanding of the market of the product, such as the sales price, as well as its influence and reputation in the whole market. This is the most important thing. Generally speaking, it is not that the better the advertisement is, the better the reputation of the product will be, but the products produced by the manufacturer with good reputation will generally have the same quality It is more secure and reliable, which not only helps the purchasing and bosses to omit a lot of troublesome things in the later stage, save more time to do other things, but also won&amp;#39;t get burned when the delivery date is approaching due to the original wrong choice. So it&amp;#39;s very important to polish your eyes and find a qualified magnet manufacturer. Al magnetoelectric Co., Ltd. makes good faith goods. As long as every new and old customer&amp;#39;s order is delivered to us, Al&amp;#39;s owners will try their best to do it as their own thing. Timely delivery, quality assurance, good after-sales service of every order, never participate in it. I What we do is to be honest and strive to implement every step&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Second, when choosing a strong magnet, you need to make some comparison, or sex price comparison. There may be a very low price in the market, but its performance and pull force will also be very low. The quality and relative price of the big goods made by each manufacturer due to the different amount of raw materials are also different. Therefore, when choosing strong magnets, we should make more comparison, which can reduce the blindness and follow-up when buying.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Finally, Xiaobian should remind you again that when purchasing strong temperature resistant magnets, we should make a good comparison first, as the saying goes, goods are better than three; then we should choose a magnet manufacturer with high cost performance and more suitable for our own products to cooperate according to the seller&amp;#39;s product quality, price, service attitude and after-sales service, which is the most effective choice.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1619774239, 1619774386),
(4, 'What is the difference between N pole and S pole of magnet', 'What-is-the-difference-between-N-pole-and-S-pole-of-magnet', 'What is the difference between N pole and S pole of magnet', 'What is the difference between N pole and S pole of magnet', 10003, '&lt;p&gt;&lt;span&gt;The experimental results show that the method is as follows:&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:0&quot;&gt;&lt;span&gt;1. &lt;/span&gt;&lt;span&gt;Tie the bar magnet with cotton thread and lift it to make it static. The north end is the North (n) pole of the bar magnet, and the other end is the South (s) pole.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:0&quot;&gt;&lt;span&gt;2. &lt;/span&gt;&lt;span&gt;Make one end of the bar magnet close to the S-pole of the stationary small magnetic needle. If the S-pole of the small magnetic needle does not move, the end of the bar magnet close to the S-pole is the N-pole. If the S-pole of the small magnetic needle deflects, the end of the bar magnet close to the S-pole is the S-pole. This is based on the principle that the bar magnet has the characteristics of North and south, repelling the same pole and absorbing the different pole.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;3. Power on the iron core placed in the middle of the coil. The direction of the magnetic field is opposite to the direction of the current. The direction of the magnetic field is from south to north. If the current is from a to B, then B is the South Pole. Use a magnet to get close to the iron core and draw on one end of the iron core. It is known that the pole where the magnet is drawn is opposite to the iron core, that is, the pole where the magnet is drawn on B is the North Pole.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;There are interactions between magnetic poles, i.e. same-sex repulsion and opposite-sex attraction. That is to say, N-pole and S-pole will attract each other when they are close, and N-pole and N-pole will repel each other when they are close. Knowing this, we can understand why the compass automatically indicates the direction.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Because the earth is a huge magnet, its N-pole is near the geographical south pole, and its S-pole is near the geographical North Pole. If a long bar magnet is hung from the middle with thin wire to let it rotate freely, then the N-pole of the magnet and the S-pole of the earth will attract each other, and the S-pole of the magnet and the N-pole of the earth will attract each other, making the magnet rotate until the N-pole and S-pole of the magnet When the poles point to the s and N poles of the earth, the N pole of the magnet indicates the geographical North Pole.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1619775246, 1619775246),
(5, 'What are the shapes and uses of magnets', 'What-are-the-shapes-and-uses-of-magnets', 'What are the shapes and uses of magnets', 'What are the shapes and uses of magnets', 10003, '&lt;p&gt;&lt;span&gt;I. special magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;The above magnets are relatively common magnets, while the special-shaped magnets are mainly used in special occasions, such as magnetic connectors and some non-standard parts. The common special-shaped magnets include large and small head magnets, T-shaped magnets, beveling magnets, semicircle magnets, concave magnets, convex magnets, slotted magnets, etc.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;II. Spherical magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Spherical magnets are often sold as toys and novelty items. They can be used to make popular table toys, such as rattlesnake eggs, and various shapes can also be used to make bracelets and necklaces.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;III. bar magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;The strength of magnets is concentrated in the two poles, but weaker on both sides. They are the most commonly used shapes in daily life, such as refrigerator magnets and compass. Bar magnets are also used in classroom demonstrations. For example, you can use a bar magnet to show the magnetic field by placing metal chips on paper that hides the magnet.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;IV. cylindrical magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;A magnet with a height greater than the diameter, usually magnetized radially. Of course, it can also be axially, mainly depending on the actual needs of customers. It is suitable for magnetic toys, hall induction, galvanometer and medical equipment.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;V. horseshoe magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;A horseshoe magnet is a U-shaped bar magnet. The U-shape makes the poles point in the same direction, which makes the magnet stronger. Originally as a replacement for bar magnets, this shape has become a universal symbol for magnets. According to the strength of the horseshoe magnet, it can be used to pick up metal objects of any size. For example, small horseshoes can collect paper clips, while industrial sized horseshoe magnets are used in construction and engineering to collect large pieces of heavy metals, and horseshoe magnets are also used at the bottom of a pendulum&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Vi. ring magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Ring magnets are widely used in scientific experiments, such as demonstration of magnetic repulsion, passing the magnetic ring through a wooden pole, when the same magnetic poles contact each other, they will not contact, as well as magnetic levitation, electric motor, electroacoustic, salvage, medicine, etc.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;VII. Counterbore magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;That is to say, punch a countersunk hole on the basis of round, square, column, ring and tile magnets, and use them together with screws.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;VIII. Round magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;The circular magnet can increase its attraction (how to increase the strong magnet magnetism) by increasing its thickness. Because the surface of the circular magnet is wide and flat, and the area of the magnetic pole is large, it becomes a strong and effective magnet. According to the size of the circle, this shape can be used for many purposes, such as packaging handbags, personal experiments, electronic products, smart home, etc.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;IX. tile / arc magnet&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Tile magnet, also called arc magnet, bending magnet, is commonly used in various permanent magnet DC motors.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1619775570, 1619775570),
(6, 'Distinguish between good and bad magnets', 'Distinguish-between-good-and-bad-magnets', 'Distinguish between good and bad magnets', 'In the past 30 years, with the extensive development of magnet products, NdFeB magnets have been widely used in various industries, especially magnetic levitation and electronic digital products. In the past 30 years, there have been many different brands', 10003, '&lt;p&gt;&lt;span&gt;In the past 30 years, with the extensive development of magnet products, NdFeB magnets have been widely used in various industries, especially magnetic levitation and electronic digital products. In the past 30 years, there have been many different brands. Consumers are also confused about how to determine the quality of NdFeB magnets. Judging the advantages and disadvantages of NdFeB magnets should be considered from three aspects: magnet function, magnet scale and magnet coating.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;The control of the production of the material ensures the function of the magnet: First, it is necessary to consider whether the raw materials used by the NdFeB magnet manufacturers meet the national standards, and secondly, the advanced production skills of the NdFeB magnet manufacturers should be considered. Advanced skills now include sheet ingot casting skills, hydrogen crushing skills and airflow crushing skills. Secondly, we should consider whether to adopt the two-part compression molding method, which is also the characteristics of the production of NdFeB magnets in China. Finally, we should monitor the quality during the production process. PFM can be used for effective detection. We can select the type of NdFeB magnets by checking various magnet parameters.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Machining ability ensures magnet scale: NdFeB magnets are various in shape, and different shapes of NdFeB magnets have different scales. It is difficult to form in one production during normal production, and it must pass through the cutting and production process. The size of the high-quality magnet also has a great influence, and the size of the magnet depends on the processing capacity of the factory. Because of this, we can continue to meet the needs of our customers while saving manpower and resources and making the company more competitive.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;The quality of the coating determines the life of the NdFeB magnet: a magnet without a magnet coating will have a life of 20-30 years at 51 ° C in air at 80 ° C and needs to be plated on the surface. In existing skills, a layer of barrier material is usually applied to the surface of the magnet to prevent foreign matter from corroding the magnet. Chemicals such as nickel and copper are commonly used for blocking, but in some special cases, phosphating should be used. The customer should select the plating process according to the product operation requirements.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;In summary, to determine the quality of NdFeB magnets, it is necessary to understand the production process, and fully understand its functions, scales, plating and so on.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;AIM Magnte would give you the best service,welcome to inquiry!&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1620392563, 1620392563),
(7, 'How to get the magnetic material on the plane and quickly reach the customer', 'How to get the magnetic material on the plane and quickly reach the customer', 'How to get the magnetic material on the plane and quickly reach the customer', 'Air transportation has certain special characteristics. In order to ensure safety, both people and goods need to be inspected before taking the flight. If you carry magnetic materials when you take the flight, such as NdFeB magnets, or if customers are an', 10003, '&lt;p&gt;&lt;span&gt;How to get the magnetic material on the plane and quickly reach the customer&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Air transportation has certain special characteristics. In order to ensure safety, both people and goods need to be inspected before taking the flight. If you carry magnetic materials when you take the flight, such as NdFeB magnets, or if customers are anxious to ask for the goods to be shipped by air, can we bring the magnets to the aircraft at this time? Today, let everyone know how the magnetic material is on the plane~&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Air freight standard&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;According to the relevant provisions of IATA902: If the maximum magnetic field strength measured at 2.1m from the measured object does not exceed 0.159A/m (200nT, which is equal to 2mGs=0.002Gs), the article is not restricted as a magnetic substance and can be used as General cargo processing.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;If the maximum magnetic field strength measured at 2.1 m from the object under test exceeds 0.159 A/m, but any magnetic field strength at 4.6 m from the surface of the object to be tested is less than 0.418 A/m, the cargo can be accepted as dangerous goods.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;If any magnetic field strength at 4.6 m from the surface of the object to be tested is greater than 0.418 A/m, the item is strictly prohibited from being transported by air.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;How to meet air transport standards&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;In order to meet the above air transportation requirements, it is necessary to degauss the airborne magnet. Although it is called degaussing, it is not demagnetizing the magnet. Instead, the special shielding package is used to make the magnetic display of the package meet the specified aviation safety transportation requirements. Shielding and packaging generally use high-magnetic materials, such as cold-rolled sheets, galvanized sheets, etc. If the amount of magnetic material is large, it is necessary to pack several layers. The permeability of high-magnetic materials is very high. According to the Faraday cage principle, the magnetic field is mainly circulated in the box after packaging, and there is very little leakage. Cover the package and pack it in a cardboard or wooden box.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1620460962, 1620460962),
(8, 'Magnets for life', 'Magnets for life', 'Magnets for life', 'Magnet, is composed of iron, cobalt, nickel atoms, with its own magnetic moment of material, can produce a magnetic field, with the attraction of ferromagnetic materials such as iron, nickel, cobalt and other metal properties.After a long time of developm', 10003, '&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Magnet, is composed of iron, cobalt, nickel atoms, with its own magnetic moment of material, can produce a magnetic field, with the attraction of ferromagnetic materials such as iron, nickel, cobalt and other metal properties.After a long time of development, magnet in the life of the application of more and more widely, life can be seen everywhere their shadow.The following is a brief introduction for you, hope to give you some help.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;strong&gt;&lt;span&gt;A magnet for life:&lt;/span&gt;&lt;/strong&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:14px&quot;&gt;&lt;span&gt;1. &lt;/span&gt;&lt;span&gt;Refrigerator door magnetic bar: the magnetic stripe installed on the refrigerator door can make the refrigerator door and refrigerator body closeConnected to achieve good cooling effect.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:14px&quot;&gt;&lt;span&gt;2. &lt;/span&gt;&lt;span&gt;magnetic buckle bag: in general, the opening of the bag with magnetic buckle, easy to carry, but also to prevent theft.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:14px&quot;&gt;&lt;span&gt;3. &lt;/span&gt;&lt;span&gt;&amp;nbsp;magnetic tool pendant: can be used to hang iron, key chain, etc.For hanging objects, glue the back of the hook so that it can be glued to similar objects such as walls or cabinets.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:14px&quot;&gt;&lt;span&gt;4. &lt;/span&gt;&lt;span&gt;&amp;nbsp;Automatic water inlet and outlet valve cleaning machine: water inlet system of automatic washing machine adopts water level pressure switch and water inlet valve, which is controlled by program controller.The overflow port is arranged at the upper port of the barrel.When rinsing, it allows the cleaning fluid to overflow with foam and sewage.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Thus, small magnets have such a wide range of applications and, of course, they have a unique &amp;quot;attraction&amp;quot; in the world.Second, the magnetic field of applicationMotor field: VCM, CD, wind turbine, motor, servo motor, micro motor, motor, vibration motor, etc.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;strong&gt;&lt;span&gt;In mechanical equipment:&lt;/span&gt;&lt;/strong&gt;&lt;span&gt; magnetic separation, magnetic separator, magnetic crane, magnetic machinery;&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;strong&gt;&lt;span style=&quot;font-size:14px;font-family:&amp;#39;Calibri&amp;#39;,sans-serif&quot;&gt;In medical care:&lt;/span&gt;&lt;/strong&gt;&lt;span style=&quot;font-size:14px;font-family:&amp;#39;Calibri&amp;#39;,sans-serif&quot;&gt; nuclear magnetic resonance instrument, medical equipment, magnetic therapy health care products;In the field of electroacoustic: loudspeaker, receiver, microphone, all kinds of sound;In electronic appliances: vacuum circuit breaker of permanent magnet mechanism, magnetic latching relay, sensor, etc.In other industries: magnetization waxproof device, pipe duster, magnetic fixture, automatic majiang machine, magnetic lock, door and window magnetic, case and bag magnetic, leather magnetic, toy magnetic, tool magnetic, etc.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1620662012, 1620662012),
(9, 'Sintered magnet', 'Sintered magnet', 'Sintered magnet', 'Development of sintered ndfeb magnet production process Sintered magnet is the largest commodity magnet at present.The process basically follows the powder metallurgy method of preparing samarium -- cobalt magnets, and the procedures are as follows', 10003, '&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Development of sintered ndfeb magnet production process Sintered magnet is the largest commodity magnet at present.The process basically follows the powder metallurgy method of preparing samarium -- cobalt magnets, and the procedures are as follows: melting -- alloy ingot grinding -- grinding -- oriented forming under magnetic field -- sintering -- tempering aging -- magnetizing testing, etc.Firstly, Fe and B are smelted into fe-b alloy, and then they are melted into ternary alloy under Ar gas in vacuum reactor according to certain ratio, and cast into water-cooled copper mold.Then, the powder is made by ball milling and air milling, reduction diffusion powder making, HDDR powder making, rapid quenching technology with ball milling or air milling, etc.The permanent magnetic properties of sintered ndfeb magnets depend on their intrinsic magnetism and microstructure.Intrinsic magnetism is mainly determined by the chemical composition of the material, is not sensitive structure.Intrinsic magnetism determines the theoretical limit of macroscopic magnetic properties of the material. In order to obtain high-performance ndfeb magnet, the saturation magnetic polarization intensity of the magnetic phase in ndfeb magnet should be firstly improved.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;;text-indent:0&quot;&gt;&lt;span&gt;(2) &lt;/span&gt;&lt;span&gt;increase the amount of ndfeb magnets in the magnetic phase, this can be achieved by the proper component ratio, on the premise of guarantee the coercive force makes the component close to magnetic phase component of production after magnet &lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;(3) improve the magnetic orientation degree, magnets, mainly through the production process is the particles in the single crystal grain or close to the single crystal particles, and have good particle size distribution.On the premise of certain purity of raw materials, the production process determines the properties of magnets.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;China&amp;#39;s production of ndfeb is generally blank, need further surface machining.Neodymium iron boron magnet is brittle, mechanical properties are poor, generally can only use grinding and cutting workers.With the development of ndfeb industry, the demand for ndfeb magnet is higher and higher, some magnets are designed to be very small, very thin, weight only 10 mg to dozens of mg, shape is very complex, the original processing equipment can not meet the needs of ndfeb processing.At the same time, the neodymium iron boron magnet has poor corrosion resistance, generally after surface corrosion treatment can be used, currently mainly using protective coating method for corrosion prevention.Commonly used metal coating Ni, Zn and so on, with electroplating, electroless plating method to cover the surface of the magnet;A common polymer coating is epoxy resin, which covers the surface of magnets by spraying and electrophoresis.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1620744927, 1620744927),
(10, 'Strong magnetic magnet', 'Strong-magnetic-magnet', 'Strong magnetic magnet', 'There are many kinds of high temperature resistant strong magnetic magnets, generally divided into permanent magnet and soft magnetic two categories, we said the magnet, generally refers to the permanent magnet', 10003, '&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;There are many kinds of high temperature resistant strong magnetic magnets, generally divided into permanent magnet and soft magnetic two categories, we said the magnet, generally refers to the permanent magnet&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Permanent magnet magnets are classified into two major categories:&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;The first category is: metal alloy magnets including Nd2Fe14B magnet, samarium cobalt magnet (SmCo), ALNiCO magnet (ALNiCO)&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;The second category is Ferrite.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;1. Neodymium iron boron magnet: it is the most commercially available magnet, known as magneto, with extremely high magnetic capacity. Its maximum magnetic energy product (BHmax) is 10 times higher than Ferrite.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Its mechanical processing performance is also quite good.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Operating temperature up to 200&lt;/span&gt;&lt;span style=&quot;font-family:宋体&quot;&gt;℃&lt;/span&gt;&lt;span&gt;.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;And its hard texture, stable performance, there is a good cost performance, so its application is extremely wide.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;However, its surface processing is necessary for its strong chemical activity.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;(e.g. Zn,Ni, electrophoresis, passivation, etc.)&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Ferrite magnet: its main raw materials include BaFe12O19 and SrFe12O19.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Made by ceramic process, it is hard in texture and brittle in material.it has become the most widely used permanent magnet because of its good temperature resistance, low price and moderate performance.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Aluminium-nickel-cobalt magnet: it is an alloy composed of aluminum, nickel, cobalt, iron and other trace metal elements.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;The casting process can be machined into different sizes and shapes with good machinability.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Cast al - ni - co permanent magnet has the lowest reversible temperature coefficient, the working temperature can be up to 600&lt;/span&gt;&lt;span style=&quot;font-family:宋体&quot;&gt;℃&lt;/span&gt;&lt;span&gt;.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Alnico permanent magnet products are widely used in various instruments and other application fields.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;SmCo can be divided into SmCo5 and Sm2Co17 according to the composition.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Its development is limited by the high cost of its materials.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;As a rare earth permanent magnet, SmCo has high magnetic energy product (14-28 mgoe), reliable coercivity and good temperature characteristics.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Compared with ndfeb magnets, samarium cobalt magnets are more suitable for high temperature environments.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;5. The value of the required reverse magnetic field strength when the magnet is reversely magnetized after saturation magnetization of the strong magnet technology, to reduce the magnetic induction intensity to zero, is called magnetic inductive coercivity (Hcb).&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;However, the magnetization of the magnet is not zero at this time, but the interaction between the added reverse magnetic field and the magnetization of the magnet cancels each other.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;(external magnetic induction intensity is zero) at this time, if the external magnetic field is withdrawn, the magnet still has certain magnetic properties.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;The coercivity of ndfeb is generally over 11000Oe.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;When a magnet is magnetized by an external magnetic field in a closed circuit and the external magnetic field is cancelled after the technology is saturated, the magnetic induction intensity of the magnet is called remanence.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;It represents the maximum flux that a magnet can provide.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;It can be seen from the demagnetization curve that it corresponds to the situation when the air gap is zero, so the magnetic induction intensity of the magnet in the actual magnetic circuit is smaller than the residual magnetism.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Neodymium iron boron is the highest practical permanent magnetic material found in&lt;st1:country-region w:st=&quot;on&quot;&gt;Br.&lt;/st1:country-region&gt;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;A strong magnet reduces the magnetization of a magnet to zero.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Intrinsic coercivity is a physical quantity to measure the anti-demagnetization ability of magnets. If the external magnetic field equals to the intrinsic coercivity of magnets, the magnetism of magnets will be basically eliminated.&lt;/span&gt;&lt;/p&gt;&lt;p style=&quot;text-indent:14px&quot;&gt;&lt;span&gt;Ndfeb&amp;#39;s Hcj will decrease with the increase of temperature, so we should choose high Hcj brand when we need to work in high temperature environment.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1621859699, 1621859699),
(11, 'How to distinguish between NdFeB and ferrite', 'How-to-distinguish-between-NdFeB-and-ferrite', 'How to distinguish between NdFeB and ferrite', 'NdFeB is simply a kind of magnet. What is different from the magnets that we often see on the day is that it is called &quot;Magnetic King&quot; because of its excellent magnetic function. NdFeB contains a large amount of rare earth elements lanthanum, ir', 10003, '&lt;p&gt;&lt;span&gt;NdFeB is simply a kind of magnet. What is different from the magnets that we often see on the day is that it is called &amp;quot;Magnetic King&amp;quot; because of its excellent magnetic function. NdFeB contains a large amount of rare earth elements lanthanum, iron and boron, and its properties are hard and brittle. Because the surface is highly susceptible to oxidative attack, NdFeB must be surface coated. Surface chemical passivation is one of the best ways to handle it. NdFeB as a kind of rare earth permanent magnet raw material has a very high magnetic energy product and coercive force, and the high energy density advantage makes NdFeB permanent magnet raw materials have been used in the modern industry and electronic technology, so that the instrument It is possible to reduce the size, weight, and thickness of instruments, electroacoustic motors, and magnetic separation magnetization. The advantage of NdFeB is high cost performance and excellent mechanical properties. The disadvantages are low operating temperature, poor temperature characteristics, and easy pulverization. It must be adjusted by chemical composition and surface treatment to improve it. Arrival requirements for essential use. NdFeB magnetic raw materials, as a new control consequence of the development of rare earth permanent magnet raw materials, are called &amp;quot;Magnetic King&amp;quot; due to their excellent magnetic function. The neodymium iron boron magnetic material is an alloy of base metal or boron iron. Also known as magnetic steel.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;Ferrite is a metal oxide with ferromagnetism. In terms of electrical properties, ferrite has a much higher electrical resistivity than metal and alloy magnetic materials, and has a higher dielectric function. The magnetic function of ferrite also exhibits a high magnetic permeability at high frequencies. Therefore, ferrite has become an ordinary non-metallic magnetic material for use in high-frequency weak current limits. Since the magnetic energy stored in the unit volume of ferrite is low, the saturation magnetization is also low (usually only 1/3 to 1/5 of pure iron), thus limiting its low-frequency high-voltage that requires higher magnetic energy density. Use of the boundary with the great power.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10, 0, 20, 1621959066, 1621959066);

-- --------------------------------------------------------

--
-- 表的结构 `hishop_article_image`
--

CREATE TABLE IF NOT EXISTS `hishop_article_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `article_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '文章id',
  `image_id` int(11) NOT NULL COMMENT '图片id(关联文件记录表)',
  `image_name` varchar(100) NOT NULL DEFAULT '' COMMENT '图片的其它名字',
  `image_alt` varchar(100) NOT NULL DEFAULT '' COMMENT '图片的alt内容',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `hishop_article_image`
--

INSERT INTO `hishop_article_image` (`id`, `article_id`, `image_id`, `image_name`, `image_alt`, `create_time`) VALUES
(7, 3, 7, '20210430/How-to-choose-high-quality-manufacturers-when-purchasing-magnets.jpg', 'How-to-choose-high-quality-manufacturers-when-purchasing-magnets', 1619774386),
(8, 4, 8, '20210430/What-is-the-difference-between-N-pole-and-S-pole-of-magnet.jpg', 'What-is-the-difference-between-N-pole-and-S-pole-of-magnet', 1619775246),
(9, 5, 9, '20210430/What-are-the-shapes-and-uses-of-magnets.jpg', 'What-are-the-shapes-and-uses-of-magnets', 1619775570),
(10, 6, 13, '', '', 1620392563),
(11, 7, 10, '20210508/How-to-get-the-magnetic-material-on-the-plane-and-quickly-reach-the-customer.jpg', 'How to get the magnetic material on the plane and quickly reach the customer', 1620460962),
(12, 8, 16, '20210510/Magnets-for-life.jpg', 'Magnets for life', 1620662012),
(13, 9, 17, '', '', 1620744927),
(14, 10, 12, '20210524/Strong-magnetic-magnet.jpg', 'Strong magnetic magnet', 1621859699),
(15, 11, 19, '20210526/How-to-distinguish-between-NdFeB-and-ferrite.jpg', 'How to distinguish between NdFeB and ferrite', 1621959066);

-- --------------------------------------------------------

--
-- 表的结构 `hishop_art_category`
--

CREATE TABLE IF NOT EXISTS `hishop_art_category` (
  `art_category_id` int(11) unsigned NOT NULL COMMENT '商品分类id',
...
--
-- 转存表中的数据 `hishop_art_category`
--

INSERT INTO `hishop_art_category` (`art_category_id`, `name`, `parent_id`, `image_id`, `sort`, `create_time`, `update_time`) VALUES
(10003, '文章分类1', 0, 10003, 100, 1614613494, 1614614644);

-- --------------------------------------------------------

--
-- 表的结构 `hishop_category`
--

CREATE TABLE IF NOT EXISTS `hishop_category` (
...
--
-- 转存表中的数据 `hishop_category`
--

INSERT INTO `hishop_category` (`category_id`, `name`, `parent_id`, `image_id`, `sort`, `create_time`, `update_time`) VALUES
(10002, '磁铁形状', 0, 10003, 100, 1610215020, 1619751151),
(10003, '长条形磁铁', 10002, 0, 100, 1619751180, 1619751213),
(10005, '方块形磁铁', 10002, 0, 100, 1619751245, 1619751245),
(10006, '瓦形磁铁', 10002, 0, 100, 1619751261, 1619751337),
(10007, '圆环形磁铁', 10002, 0, 100, 1619751302, 1619751302),
(10008, '圆柱形磁铁', 10002, 0, 100, 1619751327, 1619751327),
(10009, '圆片形磁铁', 10002, 0, 100, 1619751364, 1619751364),
(10010, '磁铁属性', 0, 0, 100, 1619751421, 1619751421),
(10011, '钐钴磁体', 10010, 0, 100, 1619751446, 1619751446),
(10012, '钕铁硼磁铁（强力磁铁）', 10010, 0, 100, 1619751461, 1619751494),
(10013, '铁氧体磁铁', 10010, 0, 100, 1619751478, 1619751478),
(10014, '铝镍钴磁铁', 10010, 0, 100, 1619751530, 1619751530),
(10015, '铁铬钴磁铁', 10010, 0, 100, 1619751550, 1619751550),
(10016, '磁铁行业', 0, 0, 100, 1619751980, 1619751980),
(10017, '磁性组件', 10016, 0, 100, 1619751997, 1619751997),
(10018, '电机磁铁', 10016, 0, 100, 1619752013, 1619752013),
(10019, '橡胶磁铁', 10016, 0, 100, 1619752034, 1619752034),
(10020, '塑磁', 10016, 0, 100, 1619752050, 1619752050);
...
CREATE TABLE IF NOT EXISTS `hishop_goods` (
  ...
  `is_delete` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `is_home` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '10不展示首页，20展示首页',
  `owner_name` varchar(50) NOT NULL DEFAULT '' COMMENT '供应商名',
  `owner_phone` varchar(20) NOT NULL DEFAULT '' COMMENT '供应商联系方式',
  `owner_link` varchar(255) NOT NULL DEFAULT '' COMMENT '供应商链接',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
...
--
-- 表的结构 `hishop_goods_image`
--

CREATE TABLE IF NOT EXISTS `hishop_goods_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `image_id` int(11) NOT NULL COMMENT '图片id(关联文件记录表)',
  `image_name` varchar(100) NOT NULL DEFAULT '' COMMENT '图片的其它名称',
  `image_alt` varchar(100) NOT NULL DEFAULT '' COMMENT '图片的alt',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
...
CREATE TABLE IF NOT EXISTS `hishop_help` (
  ...
  `key` varchar(20) NOT NULL DEFAULT '' COMMENT '页面平台',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
...
INSERT INTO `hishop_help` (`help_id`, `title`, `content`, `sort`, `key`, `create_time`, `update_time`) VALUES
(10001, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 'wxapp', 1529926348, 1529926348);
...
CREATE TABLE IF NOT EXISTS `hishop_page` (
...
CREATE TABLE IF NOT EXISTS `hishop_region` (
...
--
-- 转存表中的数据 `hishop_region`
--

INSERT INTO `hishop_region` (`id`, `pid`, `shortname`, `name`, `merger_name`, `level`, `pinyin`, `code`, `zip_code`, `first`, `lng`, `lat`) VALUES
...
CREATE TABLE IF NOT EXISTS `hishop_setting` (
...
--
-- 转存表中的数据 `hishop_setting`
--

INSERT INTO `hishop_setting` (`key`, `describe`, `values`, `update_time`) VALUES
('sms', '短信设置', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"1312321","AccessKeySecret":"123213","sign":"123","order_pay":{"is_enable":"0","template_code":"","accept_phone":""},"register":{"is_enable":"1","template_code":"SMS_139800030"}}}}', 1610284182),
('storage', '上传设置', '{"default":"local","engine":{"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":""}}}', 1529926348),
('store', '商城设置', '{"name":"\\u4e92\\u52a9\\u7cfb\\u7edf"}', 1637487183),
('trade', '交易设置', '{"order":{"close_days":"1","receive_days":"15"},"freight_rule":"10"}', 1613587737),
('wxapp', '微信小程序设置', '{"tabbar":{"title":"\\u5c0f\\u7a0b\\u5e8f\\u5546\\u57ce","top_text_color":"10","top_background_color":"#000000"},"app_id":"wxdbfd780593b60fdd","app_secret":"e562fe970b1ced036adb3d1de768292f","mchid":"1550313941","apikey":"9b590f88b36f7e75f591fa4a2c9a45fc","is_service":"0","service_image":"","is_phone":"0","phone_image":"","phone_no":""}', 1608904078);
...
CREATE TABLE IF NOT EXISTS `hishop_store` (
  `store_id` int(11) NOT NULL,
  `user_name` varchar(30) NOT NULL DEFAULT '' COMMENT '超级管理员账号',
...
--
-- 转存表中的数据 `hishop_store`
--

INSERT INTO `hishop_store` (`store_id`, `user_name`, `password`, `create_time`, `update_time`) VALUES
(1, 'admin', '2150fc4fd844434de6ecf45439b5b556', 1529926348, 1684161793);

-- --------------------------------------------------------

--
-- 表的结构 `hishop_upload_file`
--

CREATE TABLE IF NOT EXISTS `hishop_upload_file` (
  ...
  `file_width` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文件宽px',
  `file_height` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文件高px',
...
--
-- 转存表中的数据 `hishop_upload_file`
--

INSERT INTO `hishop_upload_file` (`file_id`, `storage`, `group_id`, `file_url`, `file_name`, `file_size`, `file_width`, `file_height`, `file_type`, `extension`, `is_delete`, `create_time`) VALUES
(5, 'local', 0, '', '20210430152003af1d35214.jpg', 7676, 400, 400, 'image', 'jpg', 0, 1619767203),
(6, 'local', 0, '', '20210430170116333542500.jpg', 15692, 400, 400, 'image', 'jpg', 0, 1619773276),
(7, 'local', 0, '', '202104301716171aa219844.jpg', 42590, 479, 639, 'image', 'jpg', 0, 1619774177),
(8, 'local', 0, '', '202104301733131d5437946.jpg', 69987, 640, 640, 'image', 'jpg', 0, 1619775193),
(9, 'local', 0, '', '20210430173850042601316.jpg', 66894, 640, 640, 'image', 'jpg', 0, 1619775530),
(10, 'local', 0, '', '202105062018482329c5455.jpg', 75806, 400, 400, 'image', 'jpg', 0, 1620303528),
(11, 'local', 0, '', '20210506201920f815c1320.jpg', 190904, 721, 370, 'image', 'jpg', 0, 1620303560),
(12, 'local', 0, '', '20210506202556bba1d6899.jpg', 58134, 400, 400, 'image', 'jpg', 0, 1620303956),
(13, 'local', 0, '', '202105072057410f2e78986.jpg', 31580, 400, 400, 'image', 'jpg', 0, 1620392261),
(14, 'local', 0, '', '20210507205822b7a0c9175.jpg', 31940, 400, 400, 'image', 'jpg', 0, 1620392302),
(15, 'local', 0, '', '20210507210603d38706750.jpg', 35263, 400, 400, 'image', 'jpg', 0, 1620392763),
(16, 'local', 0, '', '202105081611250d1537129.jpg', 62124, 400, 400, 'image', 'jpg', 0, 1620461485),
(17, 'local', 0, '', '20210510235846cbc3d1988.jpg', 63068, 400, 400, 'image', 'jpg', 0, 1620662326),
(18, 'local', 0, '', '2021052423564132d905851.jpg', 45795, 400, 400, 'image', 'jpg', 0, 1621871801),
(19, 'local', 0, '', '2021052600061922f731228.jpg', 5331, 400, 400, 'image', 'jpg', 0, 1621958779);

-- --------------------------------------------------------

--
-- 表的结构 `hishop_upload_group`
--

CREATE TABLE IF NOT EXISTS `hishop_upload_group` (
...
--
-- Indexes for table `hishop_admin_user`
--
ALTER TABLE `hishop_admin_user`
  ADD PRIMARY KEY (`admin_user_id`),
  ADD KEY `user_name` (`user_name`);

--
-- Indexes for table `hishop_article`
--
ALTER TABLE `hishop_article`
  ADD PRIMARY KEY (`article_id`),
  ADD UNIQUE KEY `search_name` (`search_name`),
  ADD KEY `art_category_id` (`art_category_id`);

--
-- Indexes for table `hishop_article_image`
--
ALTER TABLE `hishop_article_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hishop_art_category`
--
ALTER TABLE `hishop_art_category`
  ADD PRIMARY KEY (`art_category_id`);

--
-- Indexes for table `hishop_category`
--
ALTER TABLE `hishop_category`
  ADD PRIMARY KEY (`category_id`);

--
-- Indexes for table `hishop_goods`
--
ALTER TABLE `hishop_goods`
  ADD PRIMARY KEY (`goods_id`),
  ADD UNIQUE KEY `search_name` (`search_name`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `hishop_goods_image`
--
ALTER TABLE `hishop_goods_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hishop_help`
--
ALTER TABLE `hishop_help`
  ADD PRIMARY KEY (`help_id`);

--
-- Indexes for table `hishop_message`
--
ALTER TABLE `hishop_message`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hishop_page`
--
ALTER TABLE `hishop_page`
  ADD PRIMARY KEY (`page_id`),
  ADD KEY `wxapp_id` (`key`);

--
-- Indexes for table `hishop_region`
--
ALTER TABLE `hishop_region`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name,level` (`name`);

--
-- Indexes for table `hishop_setting`
--
ALTER TABLE `hishop_setting`
  ADD UNIQUE KEY `unique_key` (`key`);

--
-- Indexes for table `hishop_store`
--
ALTER TABLE `hishop_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `hishop_upload_file`
--
ALTER TABLE `hishop_upload_file`
  ADD PRIMARY KEY (`file_id`),
  ADD UNIQUE KEY `path_idx` (`file_name`);

--
-- Indexes for table `hishop_upload_group`
--
ALTER TABLE `hishop_upload_group`
...
--
-- AUTO_INCREMENT for table `hishop_admin_user`
--
ALTER TABLE `hishop_admin_user`
  MODIFY `admin_user_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `hishop_article`
--
ALTER TABLE `hishop_article`
  MODIFY `article_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '文章id',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `hishop_article_image`
--
ALTER TABLE `hishop_article_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `hishop_art_category`
--
ALTER TABLE `hishop_art_category`
  MODIFY `art_category_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品分类id',AUTO_INCREMENT=10004;
--
-- AUTO_INCREMENT for table `hishop_category`
--
ALTER TABLE `hishop_category`
  MODIFY `category_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品分类id',AUTO_INCREMENT=10021;
--
-- AUTO_INCREMENT for table `hishop_goods`
--
ALTER TABLE `hishop_goods`
  MODIFY `goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品id',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `hishop_goods_image`
--
ALTER TABLE `hishop_goods_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `hishop_help`
--
ALTER TABLE `hishop_help`
  MODIFY `help_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `hishop_message`
--
ALTER TABLE `hishop_message`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '消息id',AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `hishop_page`
--
ALTER TABLE `hishop_page`
  MODIFY `page_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '页面id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `hishop_region`
--
ALTER TABLE `hishop_region`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',AUTO_INCREMENT=3749;
--
-- AUTO_INCREMENT for table `hishop_store`
--
ALTER TABLE `hishop_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `hishop_upload_file`
--
ALTER TABLE `hishop_upload_file`
  MODIFY `file_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '文件id',AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `hishop_upload_group`
--
ALTER TABLE `hishop_upload_group`
