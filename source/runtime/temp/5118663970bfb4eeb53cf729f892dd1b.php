                    ...
                    <div class="widget-body">
                        <fieldset>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="article[art_category_id]" required
                                        ...
                                        <?php if (isset($catgory)): foreach ($catgory as $first): ?>
                                            <option value="<?= $first['art_category_id'] ?>"><?= $first['name'] ?></option>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="article[content]" type="text/plain"></textarea>
                                </div>
                            </div>
                            <div class="widget-head am-cf">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="article[is_home]" value="10" data-am-ucheck checked>
                                        否
                                    </label>
                                    <label class="am-radio-inline">
