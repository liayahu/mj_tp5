<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:120:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\web/../source/application/super\view\article\category\index.php";i:1614613561;s:105:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\source\application\super\view\layouts\layout.php";i:1615080373;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="am-u-sm-12">
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                            ...
                            <?php if (!empty($list)): foreach ($list as $first): ?>
                                <tr>
                                    <td class="am-text-middle"><?= $first['art_category_id'] ?></td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('article.category/edit',
                                                ['art_category_id' => $first['art_category_id']]) ?>">
                                                <i class="am-icon-pencil"></i> 编辑
                                            </a>
                                            <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                               data-id="<?= $first['art_category_id'] ?>">
                                ...
                                <?php if (isset($first['child'])): foreach ($first['child'] as $two): ?>
                                    <tr>
                                        <td class="am-text-middle"><?= $two['art_category_id'] ?></td>
                                        ...
                                        <td class="am-text-middle">
                                            <div class="tpl-table-black-operation">
                                                <a href="<?= url('article.category/edit',
                                                    ['art_category_id' => $two['art_category_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                                <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                                   data-id="<?= $two['art_category_id'] ?>">
                                                    <i class="am-icon-trash"></i> 删除
                                                </a>
                                            </div>
                                        </td>
                                    ...
                                    <?php if (isset($two['child'])): foreach ($two['child'] as $three): ?>
                                        <tr>
                                            <td class="am-text-middle"><?= $three['art_category_id'] ?></td>
                                            <td class="am-text-middle">　　　-- <?= $three['name'] ?></td>
                                            <td class="am-text-middle"><?= $three['create_time'] ?></td>
                                            <td class="am-text-middle">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?= url('article.category/edit',
                                                        ['art_category_id' => $three['art_category_id']]) ?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                    <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                                       data-id="<?= $three['art_category_id'] ?>">
                                                        <i class="am-icon-trash"></i> 删除
                                                    </a>
                                                </div>
                                            </td>
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('article.category/delete') ?>";
        $('.item-delete').delete('art_category_id', url);
