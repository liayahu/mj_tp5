<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"/www/wwwroot/guan.com/web/../source/application/index/view/index/blog.php";i:1619620742;s:70:"/www/wwwroot/guan.com/source/application/index/view/layouts/layout.php";i:1615861730;s:78:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/head.php";i:1619620844;s:77:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/nav.php";i:1619620844;s:80:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/footer.php";i:1619620844;}*/ ?>
﻿        <!doctype html>
<html lang="zxx">
    <head>
        <!-- Required meta tags -->
                    ...
                    <div class="col-lg-4 col-md-12">
                        <aside class="widget-area">
                            ...
                            <section class="widget widget_movex_posts_thumb">
                                ...
                                <article class="item">
                                    <a href="<?php echo $base_url; ?><?php echo url('index/product',['name'=>$value['goods_name']]); ?>" class="thumb">
                                        <img class="fullimage cover" role="img" src="<?php echo $value['image'][0]['file_path']; ?>"/>
                                    </a>
                                    <div class="info">
                                        <h4 class="title usmall"><a href="<?php echo $base_url; ?><?php echo url('index/product',['name'=>$value['goods_name']]); ?>"><?php echo $value['goods_name']; ?></a></h4>
                                    </div>
                                </article>
                                <?php endforeach; ?>
                            ...
                            <section class="widget widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['article_name']]); ?>"><?php echo $value['article_name']; ?> <span class="post-count">(<?php echo date('jS F Y',strtotime($value['create_time'])); ?>)</span></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </section>
                        </aside>
