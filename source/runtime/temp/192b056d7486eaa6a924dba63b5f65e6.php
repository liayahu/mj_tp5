<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"/www/wwwroot/baobomagnet.com/web/../source/application/index/view/index/blogs.php";i:1620305096;s:77:"/www/wwwroot/baobomagnet.com/source/application/index/view/layouts/layout.php";i:1619704830;s:85:"/www/wwwroot/baobomagnet.com/source/application/index/view/layouts/_template/head.php";i:1619704838;s:84:"/www/wwwroot/baobomagnet.com/source/application/index/view/layouts/_template/nav.php";i:1619704838;s:87:"/www/wwwroot/baobomagnet.com/source/application/index/view/layouts/_template/footer.php";i:1620295040;}*/ ?>
﻿<!doctype html>
<html lang="zxx">
    <head>
        <!-- Required meta tags -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            <div class="image">
                                <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['search_name']]); ?>"><img src="<?php echo $value['image'][0]['file_path']; ?>" alt="<?php echo $value['article_name']; ?>"></a>
                                
                                <div class="date">
                                    <span><?php echo date('jS F Y',strtotime($value['create_time'])); ?></span>
                                </div>
                            </div>
                            <div class="content">
                                <h3>
                                    <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['search_name']]); ?>"><?php echo $value['article_name']; ?></a>
                                </h3>
                                <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['search_name']]); ?>" class="blog-btn">Read More +</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
