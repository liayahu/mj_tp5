<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:111:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\web/../source/application/super\view\article\index.php";i:1619704831;s:105:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\source\application\super\view\layouts\layout.php";i:1619704833;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">文章管理</div>
                </div>
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                        ...
                                        <a href="<?= $item['image'][0]['file_path'] ?>"
                                           title="点击查看大图" target="_blank">
                                            <img src="<?= $item['image'][0]['file_path'] ?>"
                                                 width="50" height="50" alt="文章图片">
                                        </a>
                                    </td>
                                    <td class="am-text-middle">
                                        <p class="item-title"><?= $item['article_name'] ?></p>
                                    </td>
                                    <td class="am-text-middle"><?= $item['category']['name'] ?></td>
                                    <td class="am-text-middle">
                                            <span class="<?= $item['is_home']['value'] == 20 ? 'x-color-green'
                                                : 'x-color-red' ?>">
                                            <?= $item['is_home']['text'] ?>
                                            </span>
                                    </td>
                                    ...
                                    <td class="am-text-middle">
                                            <span class="<?= $item['article_status']['value'] == 10 ? 'x-color-green'
                                                : 'x-color-red' ?>">
