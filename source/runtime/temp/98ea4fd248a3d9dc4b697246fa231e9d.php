<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"/www/wwwroot/guan.com/web/../source/application/index/view/index/index.php";i:1619621104;s:70:"/www/wwwroot/guan.com/source/application/index/view/layouts/layout.php";i:1615861730;s:78:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/head.php";i:1619620844;s:77:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/nav.php";i:1619620844;s:80:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/footer.php";i:1619620844;}*/ ?>
﻿        <!doctype html>
<html lang="zxx">
    <head>
        <!-- Required meta tags -->
            ...
            <div class="container-fluid">
                ...
                <div class="projects-slider owl-carousel owl-theme">
                    ...
                    <div class="projects-item">
                        <div class="image">
                            <a href="<?php echo $base_url; ?><?php echo url('index/product',['name'=>$value['goods_name']]); ?>"><img src="<?php echo $value['image'][0]['file_path']; ?>" alt="<?php echo $value['goods_name']; ?>"></a>
                        </div>
                        <div class="content">
                            <h3>
                                <a href="<?php echo $base_url; ?><?php echo url('index/product',['name'=>$value['goods_name']]); ?>"><?php echo $value['goods_name']; ?></a>
                    ...
                    <div class="col-lg-12">
                        <div class="work-process-item">
                            ...
                            <div class="work-inner-content">
                                ...
                                <p><?php echo $value['description']; ?></p>
                                <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['article_name']]); ?>" class="services-btn">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                            <?php endforeach; ?>
