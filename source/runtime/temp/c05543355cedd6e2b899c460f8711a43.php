<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"/www/wwwroot/guan.com/web/../source/application/index/view/index/blogs.php";i:1619620742;s:70:"/www/wwwroot/guan.com/source/application/index/view/layouts/layout.php";i:1615861730;s:78:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/head.php";i:1619620844;s:77:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/nav.php";i:1619620844;s:80:"/www/wwwroot/guan.com/source/application/index/view/layouts/_template/footer.php";i:1619620844;}*/ ?>
﻿<!doctype html>
<html lang="zxx">
    <head>
        <!-- Required meta tags -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            <div class="image">
                                <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['article_name']]); ?>"><img src="<?php echo $value['image'][0]['file_path']; ?>" alt="<?php echo $value['article_name']; ?>"></a>
                            ...
                            <div class="content">
                                <h3>
                                    <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['article_name']]); ?>"><?php echo $value['article_name']; ?></a>
                                </h3>
                                <a href="<?php echo $base_url; ?><?php echo url('index/blog',['name'=>$value['article_name']]); ?>" class="blog-btn">Read More +</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
