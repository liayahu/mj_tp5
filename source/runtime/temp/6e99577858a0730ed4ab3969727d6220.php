<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:111:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\b.com\web/../source/application/store\view\store\user\renew.php";i:1684161766;s:102:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\b.com\source\application\store\view\layouts\layout.php";i:1684159545;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="<?= url('store.user/renew') ?>">欢迎你，<span><?= $store['store']['user_name'] ?></span>
                        </a>
                    </li>
                    <!-- 退出 -->
                    <li class="am-text-sm">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="password" class="tpl-form-input" name="store[password]"
                                           value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="password" class="tpl-form-input" name="store[password_confirm]"
                                           value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
