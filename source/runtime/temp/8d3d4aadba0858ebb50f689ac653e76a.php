<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:114:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\web/../source/application/super\view\super\user\renew.php";i:1619704836;s:105:"C:\Users\think\my\tool\phpstudy\PHPTutorial\WWW\guan.com\source\application\super\view\layouts\layout.php";i:1619704833;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" name="super[user_name]"
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="password" class="tpl-form-input" name="super[password]"
                                           value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="password" class="tpl-form-input" name="super[password_confirm]"
                                           value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
