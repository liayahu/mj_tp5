                    ...
                    <div class="col-lg-4 col-md-12">
                        <aside class="widget-area">
                            ...
                            <section class="widget widget_movex_posts_thumb">
                                ...
                                <article class="item">
                                    <a href="{{$base_url}}{{:url('index/product',['name'=>$value['goods_name']])}}" class="thumb">
                                        <img class="fullimage cover" role="img" src="{{$value['image'][0]['file_path']}}"/>
                                    </a>
                                    <div class="info">
                                        <h4 class="title usmall"><a href="{{$base_url}}{{:url('index/product',['name'=>$value['goods_name']])}}">{{$value['goods_name']}}</a></h4>
                                    </div>
                                </article>
                                {{/foreach}}
                            ...
                            <section class="widget widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{$base_url}}{{:url('index/blog',['name'=>$value['article_name']])}}">{{$value['article_name']}} <span class="post-count">({{:date('jS F Y',strtotime($value['create_time']))}})</span></a></li>
                                    {{/foreach}}
                                </ul>
                            </section>
                        </aside>
